...
return [
    ...
    */
    ...
    'doesnt_start_with' => 'El campo :attribute no puede empezar con ninguno de los siguientes: :values.',
 ...
 /*
    ...
    | convención "atributo.regla" para nombrar las líneas. Esto facilita la especificación de un mensaje personalizado para una regla de atributo específica.
    |
    */
    ...
    | por algo más fácil de entender, como "Dirección de correo electrónico" en lugar de "correo electrónico". Esto nos ayuda a que nuestro mensaje sea más expresivo.
    |
    */
